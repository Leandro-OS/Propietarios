...
onMounted(() => {
  ...
  form.numLocales = props.comunidad.numLocales;
  form.numSotanos = props.comunidad.numSotanos;
  form.numParkings = props.comunidad.numParkings;
  form.numTrasteros = props.comunidad.numTrasteros;
});
